...
Projeto realizado no 1° e 2º ano do curso a fim de ser apresentado para a empresa IBM.
<hr>
...
* Responsável pela revisão, desenvolvimento do backend + funcionalidades aplicadas e implementação do backend no frontend.

### Cesar Moreno Fernandes:
https://github.com/CesarMFernandes
* Auxílio na codificação do frontend e produção dos diagramas.

### Eduardo Cavalcante:
https://github.com/MrEddie7

* Responsável pela codificação do arquivo "auxílio preferêncial" e produção inicial do backend
...
* Auxílio na codificação do frontend, produção dos diagramas e app mobile.
